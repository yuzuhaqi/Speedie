...
-- if you're just looking to get the library for whatever reason, just copy everything from below till you see LIBRARY END
	...
	local library = {design = getgenv().design == "kali" and "kali" or "uwuware", tabs = {}, draggable = true, flags = {}, title = getgenv().Title, open = false, mousestate = inputService.MouseIconEnabled, popup = nil, instances = {}, connections = {}, options = {}, notifications = {}, tabSize = 0, theme = {}, foldername = "uw_configs", fileext = ".uw"}
	...
	function library:Init()
		...
		if runService:IsStudio() then
			...
			if syn then pcall(function() syn.protect_gui(self.base) end) end
	...
	library.SettingsMenu:AddBind({text = "Open / Close", flag = "UI Toggle", nomouse = false, key = "LeftShift", callback = function() library:Close() end})
